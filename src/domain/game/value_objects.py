...
class LetterStatus:
    ...
    def __init__(self, letter: str, status: Literal["correct", "present", "absent"]):
    ...
    @property
    def status(self) -> Literal["correct", "present", "absent"]:
        return self._status
...
class GuessResult:
    ...
    def __repr__(self) -> str:
        return f"GuessResult({[str(l) for l in self._letters]})"
