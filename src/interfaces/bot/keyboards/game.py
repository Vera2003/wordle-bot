...
def get_difficulty_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🟢 Легко (5 букв)", callback_data="difficulty_easy"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="🟡 Средне (6 букв)", callback_data="difficulty_medium"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="🔴 Сложно (7 букв)", callback_data="difficulty_hard"
                ),
            ],
            [
...
def get_hint_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="📝 Описание гена", callback_data="hint_description"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="🔤 Буква в слове", callback_data="hint_letter"
                ),
            ],
            [
