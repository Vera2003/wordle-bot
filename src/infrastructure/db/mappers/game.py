...
from src.domain.game.entities import GameAttempt, GameSession
from src.domain.game.value_objects import GuessResult, LetterStatus, Word
from src.infrastructure.db.models.game import (
    GameAttemptModel,
    GameSessionModel,
    GuessResultPayload,
)
...
class GameMapper:
    ...
    @staticmethod
    def _guess_result_to_dict(result: GuessResult) -> GuessResultPayload:
        """
    ...
    @staticmethod
    def _reconstruct_guess_result(data: GuessResultPayload) -> GuessResult:
        """
        ...
        """
        letters = [
            LetterStatus(letter=letter_data["letter"], status=letter_data["status"])
