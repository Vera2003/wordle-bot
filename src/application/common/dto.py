...
class PaginationInput(BaseDTO):
    ...
    limit: int = Field(default=20, ge=1, le=100, description="Сколько элементов вернуть")
...
class AuditMetadata(BaseDTO):
    ...
    updated_at: Optional[datetime] = Field(None, description="Когда последний раз изменено")
